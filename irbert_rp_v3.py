...
class EmbeddingDataset(Dataset):
    def __init__(self, csv_file, zip_file_path):
        ...
        self.extracted_folder = "../MGA/embeddings"
    ...
    def __getitem__(self, idx):
        ...
        embedding_path = os.path.join(self.extracted_folder + "/", embedding_filename + ".pth")
...
if __name__ == "__main__":
    ...
    merged_csv_path = "./train_directory/merged_data.csv"
    ...
    train_data, _ = train_test_split(dataset, test_size=0.1, random_state=42)
    ...
    csv_file = "output_v3_Apr_10_24.csv"
